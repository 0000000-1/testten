        ...
        <div className='p-4 '>
            ...
            <div className=' h-[290px] px-4 flex flex-col justify-center gap-4 '>
                <div className='box flex gap-4 flex items-center w-full  overflow-scroll'>
                    <div className='textbox border-transparent border border-r-black'>
                    ...
                    <div className='textbox bg-white border-transparent border border-r-black'>
                        <div className=" minibox box p-4 flex h-[300px] w-[300px] flex-col justify-center items-center ">
                            <div className='m-3 flex gap-1'>
                                <i class="fa fa-star text-[10px] " aria-hidden="true"></i>
                                <i class="fa fa-star text-[10px] " aria-hidden="true"></i>
                    ...
                    <div className='textbox bg-white '>
