        ...
        <div className='flex gap-4 flex-col flex flex-col h-full items-center'>
            <div className=' h-screen w-full '>
                <div className='absolute z-[-2] h-full w-full '>
                    <video src={import.meta.env.BASE_URL + "./src/assets/Video_and_Ref/istockphoto-2152876030-640.mp4"} className='h-screen w-full object-cover' data-type='mp4' autoPlay loop muted playsInline></video>
                </div>
